...
public class Level16 extends AppCompatActivity {
    ...
    public void randomize16to20() throws ArithmeticException {
        ...
        if (rari == 0) {
            ...
            while (numLeft1n==0) numLeft1n = random.nextInt(3);
        ...
        if (rale == 0) {
            ...
            while (numRight1n==0) numRight1n = random.nextInt(3);
    ...
    public void closeEndAlert(View view) {
        Intent intent = new Intent(Level16.this, MainMenu.class);
