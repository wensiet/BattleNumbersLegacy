...
public class Level18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(promL==1){
            ...
            while(numLeft1==0) numLeft1=random.nextInt(15);
            numLeftS=numLeft1*numLeft1;

            numLeft2=random.nextInt(15);
            while(numLeft2==0) numLeft2=random.nextInt(15);
            ...
            numLeft1=random.nextInt(15);
            numLeft1n=random.nextInt(15);
            while(numLeft1n==0) numLeft1=random.nextInt(15);
            while(numLeft1==0) numLeft1=random.nextInt(15);
        ...
        if(promR==1){
            ...
            while(numRight1==0) numRight1=random.nextInt(15);
            numRightS=numRight1*numRight1;

            numRight2=random.nextInt(15);
            while(numRight2==0) numRight2=random.nextInt(15);
            ...
            numRight1=random.nextInt(15);
            numRight1n=random.nextInt(15);
            while(numRight1n==0) numRight1=random.nextInt(15);
            while(numRight1==0) numRight1=random.nextInt(15);
    ...
    public void closeEndAlert(View view){
        Intent intent = new Intent(Level18.this, MainMenu.class);
