...
public class Level20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(promL==1){
            ...
            while(numLeft1==0) numLeft1=random.nextInt(5);
            numLeftS=numLeft1*numLeft1;

            numLeft2=random.nextInt(5);
            while(numLeft2==0) numLeft2=random.nextInt(5);
            ...
            numLeft1=random.nextInt(5);
            numLeft1n=random.nextInt(5);
            while(numLeft1n==0) numLeft1=random.nextInt(5);
            while(numLeft1==0) numLeft1=random.nextInt(5);
        ...
        if(promR==1){
            ...
            while(numRight1==0) numRight1=random.nextInt(5);
            numRightS=numRight1*numRight1;

            numRight2=random.nextInt(5);
            while(numRight2==0) numRight2=random.nextInt(5);
            ...
            numRight1=random.nextInt(5);
            numRight1n=random.nextInt(5);
            while(numRight1n==0) numRight1=random.nextInt(5);
            while(numRight1==0) numRight1=random.nextInt(5);
    ...
    public void closeEndAlert(View view){
        Intent intent = new Intent(Level20.this, MainMenu.class);
