...
public class Level10 extends AppCompatActivity {
    ...
    public void randomize5(){
        numLeft1 = random.nextInt(26);
        while(numLeft1==0) numLeft1 = random.nextInt(26);
        numLeft2 = random.nextInt(26);
        while(numLeft2==0) numLeft2 = random.nextInt(26);
        numRight1 = random.nextInt(26);
        while(numRight1==0) numRight1 = random.nextInt(26);
        numRight2 = random.nextInt(26);
        while(numRight2==0) numRight2 = random.nextInt(26);
    ...
    public void closeEndAlert(View view){
        Intent intent = new Intent(Level10.this, MainMenu.class);
