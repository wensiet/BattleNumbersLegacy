...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CountDownTimer tillTheEnd = new CountDownTimer(25000, 1000) {
            @Override
    ...
    public void randomize3(){
        ...
        numLeft = random.nextInt(25);

        numRight = random.nextInt(25);
    ...
    public void closeEndAlert(View view){
        Intent intent = new Intent(Level3.this, MainMenu.class);
