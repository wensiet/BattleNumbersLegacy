...
public class Level9 extends AppCompatActivity {
    ...
    public void randomize5(){
        numLeft1 = random.nextInt(21);
        while(numLeft1==0) numLeft1 = random.nextInt(21);
        numLeft2 = random.nextInt(21);
        while(numLeft2==0) numLeft2 = random.nextInt(21);
        numRight1 = random.nextInt(21);
        while(numRight1==0) numRight1 = random.nextInt(21);
        numRight2 = random.nextInt(21);
        while(numRight2==0) numRight2 = random.nextInt(21);
    ...
    public void closeEndAlert(View view){
        Intent intent = new Intent(Level9.this, MainMenu.class);
