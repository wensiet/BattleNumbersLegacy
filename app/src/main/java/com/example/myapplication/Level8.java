...
public class Level8 extends AppCompatActivity {
    ...
    public void randomize5(){
        numLeft1 = random.nextInt(16);
        while(numLeft1==0) numLeft1 = random.nextInt(16);
        numLeft2 = random.nextInt(16);
        while(numLeft2==0) numLeft2 = random.nextInt(16);
        numRight1 = random.nextInt(16);
        while(numRight1==0) numRight1 = random.nextInt(16);
        numRight2 = random.nextInt(16);
        while(numRight2==0) numRight2 = random.nextInt(16);
    ...
    public void closeEndAlert(View view){
        Intent intent = new Intent(Level8.this, MainMenu.class);
